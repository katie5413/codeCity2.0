...
var Dotdotdot = (function () {
    function t(e, i) {
        ...
        r && r.destroy(),
            (this.API = {}),
            ['truncate', 'restore', 'destroy', 'watch', 'unwatch'].forEach(function (t) {
                n.API[t] = function () {
                    return n[t].call(n);
                };
            }),
        ...
        'break-word' !== s['word-wrap'] && (this.container.style['word-wrap'] = 'break-word'),
            'pre' === s['white-space']
                ...
                : 'nowrap' === s['white-space'] && (this.container.style['white-space'] = 'normal'),
            null === this.options.height && (this.options.height = this._getMaxHeight()),
            this.truncate(),
    ...
    return (
        ...
        (t.prototype.unwatch = function () {
            this.resizeEvent &&
                (window.removeEventListener('resize', this.resizeEvent), (this.resizeEvent = null)),
            ...
            if (
                ...
                if (1 == h.nodeType) {
                    ...
                    c.append(this.ellipsis),
                        h.replaceWith(c),
                        this._fits() ? c.replaceWith(h) : (c.remove(), (h = n[Math.max(0, o - 1)]));
                }
            ...
            for (
                ...
                if (((t.textContent = this._addEllipsis(n.slice(0, o).join(i))), this._fits())) {
                    'letter' == this.options.truncate &&
                        ((t.textContent = n.slice(0, o + 1).join(i)), this._truncateToLetter(t));
                    break;
                }
        }),
