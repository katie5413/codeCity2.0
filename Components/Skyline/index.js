...
function roundPathD(d) {
    return d
        ...
        .map((s) => {
            //split by spaces
            if (isNaN(s)) {
                //if the full string is not a number
...
document
    .getElementById('skytree')
    .childNodes[1].childNodes[1].setAttribute('d', draw(0, 200, skytree));
...
document.getElementById('city3').childNodes[1].childNodes[1].setAttribute('d', draw(0, 210, city3));
...
document
    .getElementById('sensoji')
    .childNodes[1].childNodes[1].setAttribute('d', draw(0, 300, sensoji));